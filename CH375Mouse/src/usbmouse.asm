...
; The SET_RETRY split, the endpoint-0 vendor request and the bulk OUT now
; live in CH375USBTOOLS/src so the FOSSIL driver uses the same copy rather
; than a divergent one.  This file assembles byte for byte as it did before.
