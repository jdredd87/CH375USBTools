program pm1mem;
{ PM1MEM -- what the card has mapped over each 16 KB of the first
  ...
  pm1card.pas).  The configured map in the shared memory is what the
...
begin
  Args;
  WriteLn('PM1MEM ', VER, ' -- the card''s memory map, live and configured');
  Rc := 0;
