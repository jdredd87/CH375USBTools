program pm1dev;
{ PM1DEV -- which of the card's emulated devices are really there,
  checked from the PC side rather than believed from the configuration.
  PicoMEM1 tools, StevenC.  Public domain (the Unlicense).

    PM1DEV [/A-] [/P=2A0]

  PM1CFG says what the card was told to emulate.  This asks the PC:
...
begin
  Args;
  WriteLn('PM1DEV ', VER, ' -- the card''s devices, asked from the PC side');
