program pm1opl;
{ PM1OPL -- play something through the AdLib the PicoMEM 1 emulates.
  ...
  audio output, before any of it is audible -- PM1CFG says whether the
...
begin
  Args;
  WriteLn('PM1OPL ', VER, ' -- the AdLib a PicoMEM can be, at 388h');
